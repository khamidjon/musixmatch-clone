...
class _TracksApi implements TracksApi {
  _TracksApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<TrackResponse> getTrack() async {
  ...
  @override
  Future<dynamic> getChartTracks({required String country}) async {
    const _extra = <String, dynamic>{};
